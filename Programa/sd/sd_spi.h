...
#define putcSPI(data_out)  do{while(!SPITBE); SPIxBUF=(data_out); }while(0)
#define WriteSPI(data_out) (SPIxBUF=(data_out))
#define ReadSPI()  (SPIxBUF)
#define TxBufFullSPI() (!SPITBE)
#define DataRdySPI() (SPIRBF)
